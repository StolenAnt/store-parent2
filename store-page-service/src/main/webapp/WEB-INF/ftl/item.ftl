...
<body ng-app="heimayi" ng-controller="itemController" ng-init="num=1;loadSku()">
...
<#--扩展属性-->
	<#assign customAttributerList=goodsDesc.customAttributeItems?eval>
<#--规格列表-->
		...
		<div id="item">
			...
			<div class="product-info">
				...
				<div class="fr itemInfo-wrap" >
					<div class="sku-name">
                        <h1 style="font-weight:bold;"><#if (goods.isMarketable=='1')>
                            {{sku.title}}
						<#else>
											 商品下架了 看看别的吧
						</#if>
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									    ...
									    <#list customAttributerList as item>
											<#if item??>
